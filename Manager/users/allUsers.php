...
<header class="header" id="header">
    ...
    <div class="bg-body text-center">
        <p class="text-start fw-bold fs-3 my-2">Users
        <a href="addUser.php" class="btn btn-info my-3 mx-2">+ New </a>
        </p>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM `users` WHERE `Position` != 'Admin' AND `Position` != 'Manager' AND `Archive` != 'Yes'";
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="editUser.php?userID=<?php echo $row['userID']; ?>"><i class='bx bx-edit text-warning' style="font-size: 30px;"></i></a>
                            <a href="deleteUser.php?userID=<?php echo $row['userID']; ?>"><i class='bx bx-trash text-danger' style="font-size: 30px;"></i></a>
                        </td>
                    </tr>
                <?php
                }
        ...
        <p class="text-start fw-bold fs-3 my-2">Deleted Users</p>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">UserID</th>
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM `users` WHERE `Position` != 'Admin' AND `Archive` = 'Yes'";
                $result = mysqli_query($conn, $sql);
                while ($row = $result->fetch_assoc()) {
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['Status']; ?></td>
                        <td>
                            <a href="relistUser.php?userID=<?php echo $row['userID']; ?>" onclick="return confirmRelist();">
    ...
    <script>
        function confirmRelist() {
            return confirm("Are you sure you want to relist this User?");
        }
    </script>
</body>
