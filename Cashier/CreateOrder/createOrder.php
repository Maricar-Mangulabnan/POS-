    ...
    <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="../SalesReport/salesReport.php" class="nav_link">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                        <a href="orderIncrease.php?productID=<?php echo $row['productID']; ?>">
                                            <i class='bx bx-message-square-add text-success' style="font-size: 30px;"></i>
                                        </a>
                                        <a href="#" onclick="passwordReduce(<?php echo $row['productID']; ?>)">
                                            <i class='bx bx-message-square-minus text-warning' style="font-size: 30px;"></i>
                                        </a>
                                        <a href="#" onclick="passwordDelete(<?php echo $row['productID']; ?>)" >
                                            <i class='bx bxs-trash text-danger' style="font-size: 30px;"></i>
                                        </a>
                                </td>
                            </tr>
                        <?php
...
<script>
        function passwordReduce(productID) {
            var enteredPassword = prompt("Enter the password:");

            // Check if the entered password is equal to "qwerty123"
            if (enteredPassword === "prettyme") {
                window.location.href = "orderReduce.php?productID=" + productID;
            } else {
                alert("Incorrect password. Access denied.");
            }
        }

        function passwordDelete(productID) {
            var enteredPassword = prompt("Enter the password:");

            // Check if the entered password is equal to "qwerty123"
            if (enteredPassword === "prettyme") {
                window.location.href = "orderDelete.php?productID=" + productID;
            } else {
                alert("Incorrect password. Access denied.");
            }
        }
